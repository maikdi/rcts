...
if __name__ == "__main__":
    ...
    for i in range(len(accounts_list)):
        try:
            ...
            out_username = current_output[0]
            out_url = current_output[1]
            out_caption = current_output[2]
            out_postdate = current_output[3]
            out_tagged = current_output[4]
            ...
            continue
    if acquired_posts == 0:
        print("Failed to acquire any posts!")
    elif acquired_posts > 0:
        print(f"Done, acquired {acquired_posts} out of {len(accounts_list)} posts.")
